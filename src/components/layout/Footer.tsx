          ...
          <div className="col-span-2">
            ...
            <div className="space-y-2.5 mb-6">
              <a
                ...
                className="flex items-center gap-2.5 text-slate-400 text-sm hover:text-emerald-400 transition-colors duration-150 w-fit"
              >
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a
                href="https://www.instagram.com/jobayer__4/?hl=en"
                target="_blank"
                rel="noopener noreferrer"
